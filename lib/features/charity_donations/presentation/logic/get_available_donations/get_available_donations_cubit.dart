...
class GetAvailableDonationsCubit extends Cubit<GetAvailableDonationsState> {
  ...
  Future<void> getAvailableDonations({bool forceRefresh = false}) async {
    ...
    result.when(
      ...
      failure: (error) {
        emit(GetAvailableDonationsState.failure(error.toString()));
      },
    );
  }
  ...
  void clearSearchAndReload() {
    ...
    getAvailableDonations(forceRefresh: true);
  }
