...
import 'package:qoot/features/charity_info/presentation/logic/charity_types/charity_types_state.dart';
...
class _EditCharityInfoScreenState extends State<EditCharityInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<UpdateCharityCubit, UpdateCharityState>(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      BlocProvider(
                        create: (_) =>
                            getIt<CharityTypesCubit>()..getCharityTypes(),
                        child:
                            BlocBuilder<CharityTypesCubit, CharityTypesState>(
                              builder: (context, state) {
                                return state.when(
                                  initial: () => _buildTypePlaceholder(),
                                  loading: () => _buildTypePlaceholder(),
                                  success: (data) {
                                    final items =
                                        data.data?.map((type) {
                                    ...
                                    return AppDropdownField<int>(
                                      ...
                                      onChanged: (val) {
                                        setState(() {
                                          typeController.text = val.toString();
                                        });
                                      },
                                      enabled: true,
                                    );
