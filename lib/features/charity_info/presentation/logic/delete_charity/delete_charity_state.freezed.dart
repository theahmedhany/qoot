...
part of 'delete_charity_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteCharityState);
}
...
/// @nodoc
class $DeleteCharityStateCopyWith<$Res>  {
$DeleteCharityStateCopyWith(DeleteCharityState _, $Res Function(DeleteCharityState) __);
}


/// Adds pattern-matching-related methods to [DeleteCharityState].
extension DeleteCharityStatePatterns on DeleteCharityState {
...
class _Initial implements DeleteCharityState {
  const _Initial();
...
@override
String toString() {
  return 'DeleteCharityState.initial()';
}
...
class Loading implements DeleteCharityState {
  const Loading();
...
@override
String toString() {
  return 'DeleteCharityState.loading()';
}
...
class Success implements DeleteCharityState {
  const Success(this.data);
  

 final  CharityResponse data;

/// Create a copy of DeleteCharityState
...
@override
String toString() {
  return 'DeleteCharityState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $DeleteCharityStateCopyWith<$Res> {
...
class Failure implements DeleteCharityState {
...
@override
String toString() {
  return 'DeleteCharityState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $DeleteCharityStateCopyWith<$Res> {
