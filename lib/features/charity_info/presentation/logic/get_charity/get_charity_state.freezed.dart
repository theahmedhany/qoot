...
part of 'get_charity_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetCharityState);
}
...
/// @nodoc
class $GetCharityStateCopyWith<$Res>  {
$GetCharityStateCopyWith(GetCharityState _, $Res Function(GetCharityState) __);
}


/// Adds pattern-matching-related methods to [GetCharityState].
extension GetCharityStatePatterns on GetCharityState {
...
class _Initial implements GetCharityState {
  const _Initial();
...
@override
String toString() {
  return 'GetCharityState.initial()';
}
...
class Loading implements GetCharityState {
  const Loading();
...
@override
String toString() {
  return 'GetCharityState.loading()';
}
...
class Success implements GetCharityState {
...
@override
String toString() {
  return 'GetCharityState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $GetCharityStateCopyWith<$Res> {
...
class Failure implements GetCharityState {
...
@override
String toString() {
  return 'GetCharityState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $GetCharityStateCopyWith<$Res> {
